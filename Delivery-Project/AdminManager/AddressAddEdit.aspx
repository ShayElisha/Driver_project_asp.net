<%@ Page Title="" Language="C#" MasterPageFile="~/AdminManager/BackAdmin.Master" AutoEventWireup="true" CodeBehind="AddressAddEdit.aspx.cs" Inherits="Delivery_Project.AdminManager.AddressAddEdit" Async="true" %>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label>כתובת</label>
                                <asp:TextBox ID="Addresses" CssClass="form-control" runat="server" placeholder="נא הזן כתובת" />
                            </div>
                            <div class="form-group">
                                <label>עיר</label>
