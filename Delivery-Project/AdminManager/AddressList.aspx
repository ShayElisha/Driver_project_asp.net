<%@ Page Title="" Language="C#" MasterPageFile="~/AdminManager/BackAdmin.Master" AutoEventWireup="true" CodeBehind="AddressList.aspx.cs" Inherits="Delivery_Project.AdminManager.AddressList" %>
                            ...
                            <asp:Repeater ID="RptProd" runat="server">
                                <ItemTemplate>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><%#Eval("address") %></td>
                                        <td><%#Eval("CityName") %></td>
                                        <td><%#Eval("corddWidth") %></td>
                                        <td><%#Eval("corddHeight") %></td>
                                        <td><%#Eval("status") %></td>
                                        <td><%#Eval("AddDate") %></td>
                                        <td class="center"><a href="AddressAddEdit.aspx?AddId=<%#Eval("AddId") %>">ערוך <spann class="fa fa-pencil"></spann></a></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater> 
                        </tbody>
