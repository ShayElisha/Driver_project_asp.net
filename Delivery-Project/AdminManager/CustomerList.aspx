<%@ Page Title="" Language="C#" MasterPageFile="~/AdminManager/BackAdmin.Master" AutoEventWireup="true" CodeBehind="CustomerList.aspx.cs" Inherits="Delivery_Project.AdminManager.CustomerList" %>
                            ...
                            <asp:Repeater ID="RptProd" runat="server" OnItemCommand="RptAddresses_ItemCommand" >
                                <ItemTemplate>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><%#Eval("status") %></td>
                                        <td><%#Eval("AddDate") %></td>
                                        <td class="center"><a href="AddressAddEdit.aspx?AddId=<%#Eval("CustomerID") %>">ערוך <spann class="fa fa-pencil"></spann></a>                                      
                                        <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" CommandArgument='<%# Eval("CustomerID") %>' Text="מחק" OnClientClick="return confirm('האם אתה בטוח שברצונך למחוק כתובת זו?');"></asp:LinkButton>                                        </tr>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater> 
                        </tbody>
